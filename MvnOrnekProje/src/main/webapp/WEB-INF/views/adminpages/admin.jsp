			...
			<div class="main-page">
				...
				<div class="row">
					<div class="col-md-8 map widget-shadow">
						...
						<!--map js-->
						<link href="<c:url value="/resources/admin/css/jqvmap.css" />" rel='stylesheet' type='text/css' />
						<script src="<c:url value="/resources/admin/js/jquery.vmap.js" />"></script>
						<script src="<c:url value="/resources/admin/js/jquery.vmap.sampledata.js" />" type="text/javascript"></script>
						<script src="<c:url value="/resources/admin/js/jquery.vmap.world.js" />" type="text/javascript"></script>
